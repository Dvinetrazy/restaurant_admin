...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Periksa apakah pengguna ada dalam daftar pengguna dan passwordnya sesuai
    if (isset($users[$username]) && $users[$username] === $password) {
        $_SESSION['username'] = $username;
        header('Location: dashboard.php'); // Alihkan ke halaman dashboard setelah login berhasil
        exit();
    } else {
...
<form class="form">
<button class="button-confirm"><a style="color: black;" href="index.php"><-- Back To Mainpage</a></button>
    <center>
  ...
  <button class="button-confirm"><a style="color: black;" href="login_form\dashboard.php">Log in</a></button>
</form>
    </div>
</body>
</html>